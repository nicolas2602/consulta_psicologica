...
config_botao={
    ...
    'bgcolor_hover':ft.colors.GREEN_400,
    'raio_borda': 10,
    'width_botao': 110,
    ...
    'icone_anotacoes': ft.icons.EDIT_DOCUMENT,
    'icone_pagamento': ft.icons.MONETIZATION_ON,
    'txt_botao1': 'Cadastro',
    'txt_botao2': 'Agendamentos',
    'txt_botao3': 'Anotações',
    'txt_botao4': 'Pagamentos',
}
...
def menu_botao(txt,icone,funcao):
    ...
    b = ft.Container(
            ...
            style= ft.ButtonStyle(
                ...
                bgcolor= {
                    ft.MaterialState.DEFAULT: config_botao['bgcolor'],
                    ft.MaterialState.HOVERED: config_botao['bgcolor_hover'],
                },
                shape= ft.RoundedRectangleBorder(radius = config_botao['raio_borda'])
            ),
